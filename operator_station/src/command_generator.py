...
class CommandGenerator(object):
    ...
    def publish_command(self):
        ...
        arm_mode, wrist_yaw, elbow_pitch, base_pitch, base_yaw, arm_home_command, arm_reset_torque_command = self.get_arm_commands()
        ...
        self._ycommand.arm_vel.home_command = arm_home_command
        self._ycommand.arm_vel.reset_torque_command = arm_reset_torque_command
